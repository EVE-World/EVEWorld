...
def main() -> None:
    ...
    ap.add_argument("--root", default="/data/datasets/flowwam/data_worldarena/640_extracted")
    ap.add_argument("--output", default="/data/datasets/flowwam/igr/manifest_640.json")
