...
class EVEFlowWAMWindowDataset:
    def __init__(
        self,
        manifest_path: str = "/data/datasets/flowwam/igr/manifest_640.json",
        anno_dir: str = "/data/datasets/flowwam/igr/anno_640",
        wmap_dir: str = "/data/datasets/flowwam/igr/weightmap_cache_640",
