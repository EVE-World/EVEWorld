...
FLOWWAM_ROOT = os.environ.get("FLOWWAM_ROOT", "/opt/eveworld/FlowWAM")
...
ANNO_DIR = "/data/datasets/flowwam/igr/anno_640"
...
def main() -> None:
    ...
    ap.add_argument("--manifest", default="/data/datasets/flowwam/igr/manifest_640.json")
    ap.add_argument("--ckpt", default="/data/datasets/flowwam/checkpoints/flowwam_worldarena_stage1.safetensors")
    ap.add_argument("--models-root", default="/data/datasets/flowwam/models")
    ap.add_argument("--out-dir", default="/data/datasets/flowwam/igr/tia_probe")
