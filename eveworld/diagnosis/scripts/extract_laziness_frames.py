...
用哪个 python 跑（有 cv2 4.11 / PIL / numpy）：
    /opt/eveworld/miniconda/envs/giga_models/bin/python extract_laziness_frames.py ...
...
REGISTRY = {
    ...
    "gigaworld0/dreamgen_98_1": {
        "video": "/data/datasets/gr1_dreamgen_eval/generated_side_by_side/"
...
DREAMGEN_SIDE_BY_SIDE_ROOT = (
    "/data/datasets/gr1_dreamgen_eval/generated_side_by_side"
)
...
# ---- 指令来源清单（按需惰性加载） ----
DREAMGEN_INPUT_JSON = ("/data/datasets/gr1_dreamgen_eval/"
                       "giga_input/gr1_dreamgen_it2v.json")
PBENCH_INPUT_JSON = "/opt/eveworld/gagibench/pbench/giga_input/pbench_robot_it2v.json"
