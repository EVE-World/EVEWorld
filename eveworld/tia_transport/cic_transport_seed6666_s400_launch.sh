...
TRAIN_PYTHON="/data/datasets/envs/giga_world_train_venv/bin/python"
PACKED="/data/datasets/gr1_finetune_data/packed_data"
PRETRAIN="/data/datasets/giga_world_0_video_pretrain/transformer"
OUTPUT="/data/datasets/eve_v2_outputs/eve_cic_transport_v1/cic_transport_seed6666_s400"
