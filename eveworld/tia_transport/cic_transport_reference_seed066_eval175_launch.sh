...
OUTPUT_ROOT="${ROOT}/eval175_references_pretrain_s000_sft_s200_seed066"
PROBE_ROOT="${ROOT}/eval175_references_pretrain_s000_sft_s200_seed066_probes"
MANIFEST_ROOT="${ROOT}/eval175_references_pretrain_s000_sft_s200_seed066_eval"
PAYLOAD="${EVEWORLD_ROOT}/eveworld/tia_transport/cic_transport_reference_seed066_eval175_kjob.sh"
...
run_check() {
  ...
  echo "Pretrain s000, SFT raw s200, and seed066 worker are ready."
}
...
submit_job() {
  ...
  output="$(
    ...
    RUN_NAME="reference_eval175_pretrain_s000_sft_s200_seed066" \
