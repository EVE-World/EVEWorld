...
OUTPUT_ROOT="${ROOT}/eval175_pretrain_raw_s000_seed005_seed025"
PROBE_ROOT="${ROOT}/eval175_pretrain_raw_s000_seed005_seed025_probes"
MANIFEST_ROOT="${ROOT}/eval175_pretrain_raw_s000_seed005_seed025_eval"
PAYLOAD="${EVEWORLD_ROOT}/eveworld/tia_transport/cic_transport_pretrain_seed005_025_eval175_kjob.sh"
...
run_check() {
  ...
  echo "Pretrain model and two-seed worker are ready."
}
...
submit_job() {
  ...
  output="$(
    ...
    RUN_NAME="pretrain_eval175_seed005_seed025" \
