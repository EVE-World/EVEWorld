...
输出: /data/datasets/agibot_ewm_train/<task>_<episode>_<segidx>.{mp4,txt}
"""
import glob
import json
import os
...
RAW = "/data/datasets/agibot_ewm_raw"
OUT = "/data/datasets/agibot_ewm_train"
TMP = "/data/datasets/agibot_ewm_raw/_extract_tmp"
