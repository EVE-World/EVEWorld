...
sys.path.insert(0, "/opt/eveworld/gagibench/EWMBench")
from EWMBench.semantics import evaluate_runs_configs  # noqa: E402

SAVE = "/data/datasets/eve_v2_outputs/ewmbench_eval"
CLIP = "/data/datasets/ewmbench_ckpt/openai_clip-vit-base-patch16"
