...
跑法 (工作机 conda giga_models 环境):
  /opt/eveworld/miniconda/envs/giga_models/bin/python t4g_probe_cpu_smoke.py
"""
import os
import sys
...
VIDEO = os.environ.get('SMOKE_VIDEO', '/data/datasets/gr1_finetune_data/raw_data/13.mp4')
NUM_BLOCKS = 28
