...
def main():
    ...
    ap.add_argument('--report', default='/data/datasets/eve_v2_outputs/selfcase/mine_round0/case_bank_report.json')
    ap.add_argument('--it2v', default='/data/datasets/gr1_dreamgen_eval/giga_input/gr1_dreamgen_it2v.json')
    ap.add_argument('--model-dir', default='/data/datasets/eve_v2_outputs/anchor_models/round0_ema_st')
    ...
    ap.add_argument('--out-dir', default='/data/datasets/eve_v2_outputs/selfcase/g1')
    run(ap.parse_args())
