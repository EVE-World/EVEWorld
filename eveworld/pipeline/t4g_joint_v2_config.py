"""联合训练 config **v2**: L_id + 增广v2 (护送贴30%关闭夹爪出生通道 + 外来物种50%治换物)。

s50 人眼发现作弊迁移(物体从夹爪上长出/换物) -> v2 教材封堵。其余同 v1。
...
config = dict(
    ...
    project_dir='/data/datasets/eve_v2_outputs/t4g_joint_v2/experiments',
    launch=dict(
