...
config = dict(
    ...
    project_dir='/data/datasets/eve_v2_outputs/t4g_wmaponly/experiments',
    launch=dict(
    ...
    models=dict(
        ...
        t4g_sigma_hi=0.5,
        t4g_warmup=20,
        t4g_lambdas='0.0,0.0',          # 消融: L_id/L_change 全关, 只留权重图
        t4g_tau=0.07,
        t4g_tol=0.2,
