...
OUT_DEFAULT = '/data/datasets/eve_v2_outputs/t4g_final/kprobe'
PRETRAIN = '/data/datasets/giga_world_0_video_pretrain'
IT2V = '/data/datasets/gr1_dreamgen_eval/giga_input/gr1_dreamgen_it2v.json'
CASE_BANK_ALL = '/data/datasets/eve_v2_outputs/selfcase/case_bank_all'
K_LIST = (2, 4, 6, 8)
...
def main():
    ...
    ap.add_argument('--weights', default='/data/datasets/eve_v2_outputs/selfcase/cic_match/ich_d_frozen_lr.npz')
