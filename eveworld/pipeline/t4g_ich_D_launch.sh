...
OUT_ROOT="/data/datasets/eve_v2_outputs/t4g_ich_D"
...
[[ -f "/data/datasets/eve_v2_outputs/selfcase/cic_match/ich_d_frozen_lr.npz" ]] || { echo "缺固化 LR, 先跑 t4g_ich_d_fit.py"; exit 1; }
