...
DEFAULT_ANNO_DIR = '/data/datasets/eve_v2_outputs/track4gen_probe/t4g_anno'
DEFAULT_ASSETS = '/data/datasets/eve_v2_outputs/track4gen_probe/aug_assets'
...
class T4GAugTransform(GigaWorld0Transform):
    ...
    def __init__(self, num_frames, height, width, image_cfg, fps=16,
        ...
        default_wmap = '/data/datasets/eve_v2_outputs/track4gen_probe/weightmap_cache'
