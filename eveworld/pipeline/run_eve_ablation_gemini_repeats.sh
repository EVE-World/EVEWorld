...
MANIFEST_ROOT="${MANIFEST_ROOT:-/data/datasets/eve_v2_outputs/eve_ablation_strict_v1_eval175_eval}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/eve_v2_outputs/gemini_eval}"
