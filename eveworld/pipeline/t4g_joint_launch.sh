...
BASE_TRANSFORMER_PATH="${BASE_TRANSFORMER:-/data/datasets/eve_v2_outputs/anchor_models/round0_ema_st/transformer}"
...
OUT_ROOT="${OUT_ROOT:-/data/datasets/eve_v2_outputs/t4g_joint}"
