...
TRAIN_ROOT="${TRAIN_ROOT:-/data/datasets/eve_v2_outputs/eve_ablation_strict_v1}"
RAW_OUTPUT_ROOT="${RAW_OUTPUT_ROOT:-/data/datasets/eve_v2_outputs/eve_ablation_strict_v1_eval175}"
EMA_OUTPUT_ROOT="${EMA_OUTPUT_ROOT:-/data/datasets/eve_v2_outputs/eve_ablation_strict_v1_eval175_ema}"
RAW_PROBE_ROOT="${RAW_PROBE_ROOT:-/data/datasets/eve_v2_outputs/anchor_models/eve_ablation_strict_v1}"
EMA_PROBE_ROOT="${EMA_PROBE_ROOT:-/data/datasets/eve_v2_outputs/anchor_models/eve_ablation_strict_v1_ema}"
