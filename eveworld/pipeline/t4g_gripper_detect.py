...
VIDEO_ROOT = '/data/datasets/gr1_finetune_data/raw_data'
...
def main():
    ...
    ap.add_argument('--out-dir', default='/data/datasets/eve_v2_outputs/track4gen_probe/gripper_anno')
    ap.add_argument('--limit', type=int, default=0)
    ap.add_argument('--device', default='cuda')
    a = ap.parse_args()
    os.makedirs(a.out_dir, exist_ok=True)
    key = {i['source_file_name'].split('.')[0]: i['prompt']
           for i in json.load(open('/data/datasets/gr1_dreamgen_eval/giga_input/gr1_dreamgen_it2v.json'))}
