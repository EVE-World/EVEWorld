...
def main():
    ...
    ap.add_argument('--video-root', default='/data/datasets/gr1_finetune_data/raw_data')
    ap.add_argument('--model-dir', default='/data/datasets/eve_v2_outputs/anchor_models/probe_anmix_s200')
