...
DATASET="${DATASET:-/data/datasets/gr1_finetune_data/packed_data}"
VAE_PATH="${VAE_PATH:-/data/datasets/giga_world_0_video_pretrain/vae}"
TRANSFORMER_PATH="${TRANSFORMER_PATH:-/data/datasets/giga_world_0_video_pretrain/transformer}"
