...
PASS=(
  "REPO_DIR=${REPO_DIR}"
  "GAGI_ROOT=${GAGI_ROOT:-/data/datasets}"
  "TRAIN_VENV=${TRAIN_VENV:-/data/datasets/envs/giga_world_train_venv}"
  "LAM_VIDEO_DIR=${LAM_VIDEO_DIR:-/data/datasets/gr1_finetune_data/raw_hf/gr1}"
  "LAT_CACHE=${LAT_CACHE:-/data/datasets/eve_outputs/latents/gr1_real.pt}"
  "LAM_OUT=${LAM_OUT:-/data/datasets/eve_outputs/lam/lam_gr1.pt}"
