...
OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/giga_world_0_outputs/eve/heldout_main}"
...
export PACKED_DATA_DIR="${PACKED_DATA_DIR:-/data/datasets/gr1_finetune_data/packed_data}"
