...
export TRAIN_VENV="${TRAIN_VENV:-/data/datasets/envs/giga_world_train_venv}"
export DATA_ROOT="${DATA_ROOT:-/data/datasets/gr1_finetune_data}"
export PACKED_DATA_DIR="${PACKED_DATA_DIR:-${DATA_ROOT}/packed_data}"
export MODEL_DIR="${MODEL_DIR:-/data/datasets/giga_world_0_video_pretrain}"
export OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/giga_world_0_outputs/eve}"
...
PASS_ARGS=(
  ...
  "LAM_CKPT=${LAM_CKPT:-/data/datasets/eve_outputs/lam/lam_gr1.pt}"
  "LAD_TOPK=${LAD_TOPK:-3}"
  "LAD_TAU=${LAD_TAU:-0.5}"
