...
`/data/datasets/giga_world_0_outputs/eve/heldout_main/eve_heldout_v1/`.
...
PHASE=validate \
RUN_TAG=eve_heldout_v1 \
VAL_DATA_PATH=/data/datasets/gr1_dreamgen_eval/giga_input/gr1_dreamgen_it2v.json \
...
PHASE=generate \
RUN_TAG=eve_heldout_v1 \
SELECTED_CHECKPOINTS=/data/datasets/giga_world_0_outputs/eve/heldout_main/eve_heldout_v1/selected_checkpoints.tsv \
...
```bash
SELECTED_CHECKPOINTS=/data/datasets/giga_world_0_outputs/eve/heldout_main/eve_heldout_v1/selected_checkpoints.tsv \
GEN_ROOT=/data/datasets/giga_world_0_outputs/eve/heldout_main/eve_heldout_v1/generation \
