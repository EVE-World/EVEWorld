...
def main() -> None:
    ...
    parser.add_argument(
        "--old-manifest",
        type=Path,
        default=Path("/data/datasets/gr1_finetune_data/raw_data/manifest.jsonl"),
    )
    parser.add_argument(
        "--metadata",
        type=Path,
        default=Path("/data/datasets/gr1_finetune_data/raw_hf/metadata.csv"),
    )
    parser.add_argument(
        "--raw-root",
        type=Path,
        default=Path("/data/datasets/gr1_finetune_data/raw_hf/gr1"),
    )
