...
config['project_dir'] = '/data/datasets/giga_world_0_outputs/physlatent_gigaworld/gr1_phase_done_aux_warmup'
...
config['dataloaders']['train']['transform']['phys_labels_path'] = (
    '/data/datasets/gr1_finetune_data/physlatent_pseudo_labels/gr1_physlabels_v3_phase_done.json'
)
