...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/data/datasets/giga_world_0_outputs/physlatent_gigaworld/experiments_adapter_warmup/models/checkpoint_epoch_100_step_200}"
export PRETRAIN_DIR="${PRETRAIN_DIR:-/data/datasets/giga_world_0_video_pretrain}"
...
export PYTHON_BIN="${PYTHON_BIN:-/data/datasets/envs/giga_world_train_venv/bin/python}"

export EVAL_ROOT="${EVAL_ROOT:-/data/datasets/gr1_dreamgen_eval}"
