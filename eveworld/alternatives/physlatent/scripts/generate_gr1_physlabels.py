...
def main() -> None:
    ...
    parser.add_argument('--packed-data-dir', type=Path, default=Path('/data/datasets/gr1_finetune_data/packed_data'))
    parser.add_argument('--raw-data-dir', type=Path, default=Path('/data/datasets/gr1_finetune_data/raw_data'))
    parser.add_argument(
        '--output',
        type=Path,
        default=Path('/data/datasets/gr1_finetune_data/physlatent_pseudo_labels/gr1_physlabels_v3_phase_done.json'),
    )
