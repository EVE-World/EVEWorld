...
MANIFEST="${MANIFEST:-/data/datasets/eve_v2_outputs/cfg_grid_seed004/gemini_if_manifest.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/data/datasets/eve_v2_outputs/gemini_eval/cfg_grid_seed004_gemini36_repeat01}"
