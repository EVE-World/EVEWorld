...
if [[ -z "${VIDEO_DIR:-}" ]]; then
  ...
  echo "  VIDEO_DIR=/data/datasets/gr1_dreamgen_eval/dreamgenbench_video_dirs/<run> ./benchmarks/dreamgenbench/launch_dreamgenbench_qwen_eval_kjob.sh" >&2
  exit 1
fi
...
export OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/gr1_dreamgen_eval/eval_outputs}"
...
export DREAMGEN_EVAL_PYTHON="${DREAMGEN_EVAL_PYTHON:-/data/datasets/envs/dreamgenbench_eval_venv/bin/python}"
