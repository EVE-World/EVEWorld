...
DEFAULT_VIDEO_DIR = Path("/data/datasets/gr1_dreamgen_eval/dreamgenbench_video_dirs/gr1_dreamgen_8gpu_full_20260625_212933")
DEFAULT_OUTPUT_ROOT = Path("/data/datasets/gr1_dreamgen_eval/eval_outputs/videophy")
