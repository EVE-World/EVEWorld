...
PYTHON="${TRAIN_PYTHON:-/data/datasets/envs/giga_world_train_venv/bin/python}"
MODEL_ROOT="${MODEL_ROOT:-/data/datasets/eve_v2_outputs/anchor_models/cfg_repro_seed42}"
DATA_ROOT="${DATA_ROOT:-/data/datasets/gr1_dreamgen_eval/giga_input}"
OUT_ROOT="${OUT_ROOT:-/data/datasets/eve_v2_outputs/cfg_grid_seed004}"
...
exec "$PYTHON" eveworld/evaluation/cfg_grid_serial_dispatch.py \
  ...
  --steps-list 50 100 150 200 250 300 --cfg-values 1.0 2.5 5.0 7.5 \
