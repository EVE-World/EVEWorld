...
SFT_CHECKPOINT_DIR="${SFT_CHECKPOINT_DIR:-/data/datasets/giga_world_0_outputs/gr1_finetune/experiments_200_clean/models/checkpoint_epoch_100_step_200}"
...
PYTHON_BIN="${PYTHON_BIN:-/opt/eveworld/miniconda/envs/giga_models/bin/python}"
