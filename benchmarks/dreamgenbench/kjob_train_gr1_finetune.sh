...
DATA_ROOT="${DATA_ROOT:-/data/datasets/gr1_finetune_data}"
PACKED_DATA_DIR="${PACKED_DATA_DIR:-${DATA_ROOT}/packed_data}"
MODEL_DIR="${MODEL_DIR:-/data/datasets/giga_world_0_video_pretrain}"
TRANSFORMER_MODEL_PATH="${TRANSFORMER_MODEL_PATH:-${MODEL_DIR}/transformer}"
VAE_MODEL_PATH="${VAE_MODEL_PATH:-${MODEL_DIR}/vae}"

OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/giga_world_0_outputs/gr1_finetune}"
