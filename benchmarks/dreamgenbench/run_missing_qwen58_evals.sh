...
PBENCH_GEN_ROOT="${PBENCH_GEN_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot_length_sweep}"
PBENCH_DOMAIN_ROOT="${PBENCH_DOMAIN_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot_qwen_vqa_eval}"
PBENCH_SWEEP_ID="${PBENCH_SWEEP_ID:-pbench_len_sweep_full_8gpu}"
PBENCH_METADATA_JSONL="${PBENCH_METADATA_JSONL:-/opt/eveworld/gagibench/pbench/giga_input/pbench_robot_it2v.metadata.jsonl}"
...
DREAMGEN_EVAL_ROOT="${DREAMGEN_EVAL_ROOT:-/data/datasets/gr1_dreamgen_eval}"
