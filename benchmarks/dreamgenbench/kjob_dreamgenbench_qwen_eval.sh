...
DREAMGEN_EVAL_PYTHON="${DREAMGEN_EVAL_PYTHON:-/data/datasets/envs/dreamgenbench_eval_venv/bin/python}"
DREAMGEN_REPO="${DREAMGEN_REPO:-/opt/eveworld/gagibench/GR00T-Dreams}"
VIDEO_DIR="${VIDEO_DIR:?Set VIDEO_DIR to generated-only DreamGenBench videos}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/gr1_dreamgen_eval/eval_outputs}"
