...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-/data/datasets/giga_world_0_outputs/gr1_finetune/experiments_200_clean/models/checkpoint_epoch_100_step_200}"
...
EVAL_ROOT="${EVAL_ROOT:-/data/datasets/gr1_dreamgen_eval}"
