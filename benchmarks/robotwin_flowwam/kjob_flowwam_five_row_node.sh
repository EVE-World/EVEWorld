...
MLR_PYTHON="${MLR_PYTHON:-/opt/eveworld/miniconda/envs/flowwam/bin/python}"
CAMPAIGN_ROOT="${CAMPAIGN_ROOT:-/data/datasets/flowwam/five_row_r250_v1}"
SOURCE_MANIFEST="${SOURCE_MANIFEST:-/data/datasets/flowwam/heldout_r250_v1/manifest.json}"
STAGE1="${STAGE1:-/data/datasets/flowwam/checkpoints/flowwam_worldarena_stage1.safetensors}"
EXISTING_EVE_VIDEOS="${EXISTING_EVE_VIDEOS:-/data/datasets/flowwam/heldout_r250_v1/arm_eve_final_robot_only}"
N_GPU="${N_GPU:-8}"
