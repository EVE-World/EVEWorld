...
MANIFEST="${MANIFEST:-/data/datasets/flowwam/heldout_r250_v1/manifest.json}"
FLOW_ROOT="${FLOW_ROOT:-/data/datasets/flowwam/heldout_r250_v1}"
OUTPUT_DIR="${OUTPUT_DIR:-/data/datasets/flowwam/heldout_r250_v1/lpips_flow_epe_v2}"
# giga_models carries the LPIPS package; RAFT is imported from FlowWAM via PYTHONPATH.
PYTHON="${PYTHON:-/opt/eveworld/miniconda/envs/giga_models/bin/python}"
