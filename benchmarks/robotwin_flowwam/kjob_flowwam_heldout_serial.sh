...
FLOWWAM_DATA="${FLOWWAM_DATA:-/data/datasets/flowwam/data_worldarena/640_extracted}"
OUT_ROOT="${OUT_ROOT:-/data/datasets/flowwam/heldout_r250_v1}"
MANIFEST="${MANIFEST:-${OUT_ROOT}/manifest.json}"
PYTHON="${PYTHON:-/opt/eveworld/miniconda/envs/flowwam/bin/python}"
...
for arm in control eve; do
  ckpt="/data/datasets/flowwam/train_runs/arm_${arm}/final.safetensors"
...
TRAIN_ROOT=/data/datasets/flowwam/train_runs \
