...
FLOWWAM_ROOT="${FLOWWAM_ROOT:-/opt/eveworld/FlowWAM}"
CONDA_SH="${CONDA_SH:-/opt/eveworld/miniconda/etc/profile.d/conda.sh}"
FLOWWAM_PYTHON="${FLOWWAM_PYTHON:-/opt/eveworld/miniconda/envs/flowwam/bin/python}"
METRIC_PYTHON="${METRIC_PYTHON:-/opt/eveworld/miniconda/envs/giga_models/bin/python}"
CAMPAIGN="${CAMPAIGN:-/data/datasets/flowwam/checkpoint_screen_v1}"
SOURCE_MANIFEST="${SOURCE_MANIFEST:-/data/datasets/flowwam/five_row_r250_v1/manifest.json}"
...
if [[ "${ROLE}" == "A" ]]; then
  CANDIDATES=(
    "sft_e0|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_sft/epoch-0.safetensors"
    "sft_e1|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_sft/epoch-1.safetensors"
    "sft_e2|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_sft/epoch-2.safetensors"
    "igr_e0|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_igr/epoch-0.safetensors"
    "igr_e1|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_igr/epoch-1.safetensors"
    "igr_e2|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_igr/epoch-2.safetensors"
  )
else
  CANDIDATES=(
    "tia_e0|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_tia/epoch-0.safetensors"
    "tia_e1|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_tia/epoch-1.safetensors"
    "tia_e2|/data/datasets/flowwam/five_row_r250_v1/checkpoints/five_row_tia/epoch-2.safetensors"
    "eve_s100|/data/datasets/flowwam/train_runs/arm_eve/step-100.safetensors"
    "eve_s200|/data/datasets/flowwam/train_runs/arm_eve/step-200.safetensors"
    "eve_e0|/data/datasets/flowwam/train_runs/arm_eve/epoch-0.safetensors"
  )
fi
