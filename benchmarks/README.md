...
- `EVEWORLD_ROOT` must point to this repository root. Data-side roots default to the `GAGI_ROOT` convention (`/data/datasets`) defined in `eveworld/common/env.sh`; most scripts also accept explicit path overrides.
