...
TRAIN_PYTHON="${TRAIN_PYTHON:-/data/datasets/envs/giga_world_train_venv/bin/python}"
WA1_ROOT="${WA1_ROOT:-/data/datasets/worldarena1}"
MANIFEST="${MANIFEST:-${WA1_ROOT}/manifests/track1_it2v.json}"
VIDEO_ROOT="${VIDEO_ROOT:-/data/datasets/eve_v2_outputs/worldarena_eval_videos}"
