...
SOURCE_REPO="${SOURCE_REPO:-/opt/eveworld/gagibench/WorldArena}"
WORLDARENA_ROOT="${WORLDARENA_ROOT:-/opt/eveworld/gagibench/WorldArena_WA1_EVAL}"
...
printf '%s  %s\n' \
  ...
  /data/datasets/worldarena_evaluator/checkpoints/sea_raft/model.safetensors | sha256sum --check
printf '%s  %s\n' \
  c1dac5b08f4c41e95452f7a41b35347409fc58b0e25b3ba8de899144ff28a350 \
  /data/datasets/worldarena_evaluator/checkpoints/vfimamba/model.pkl | sha256sum --check
printf '%s  %s\n' \
  2cd4e60f4f24ae3bcd57b847b13c1f3ba27edc28cc1a7f9ce74ee9f421243cba \
  /data/datasets/worldarena_evaluator/checkpoints/aesthetic/sa_0_4_vit_l_14_linear.pth | sha256sum --check
