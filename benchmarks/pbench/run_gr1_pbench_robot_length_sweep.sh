...
EVAL_ROOT="${EVAL_ROOT:-/data/datasets/giga_world_0_outputs}"
...
DATA_PATH="${DATA_PATH:-/opt/eveworld/gagibench/pbench/giga_input/pbench_robot_it2v.json}"
METADATA_JSONL="${METADATA_JSONL:-/opt/eveworld/gagibench/pbench/giga_input/pbench_robot_it2v.metadata.jsonl}"

GR1_CHECKPOINT_DIR="${GR1_CHECKPOINT_DIR:-/data/datasets/giga_world_0_outputs/gr1_finetune/experiments_200_clean/models/checkpoint_epoch_100_step_200}"
GR1_TRANSFORMER_SUBDIR="${GR1_TRANSFORMER_SUBDIR:-transformer_ema}"
PRETRAIN_DIR="${PRETRAIN_DIR:-/data/datasets/giga_world_0_video_pretrain}"
