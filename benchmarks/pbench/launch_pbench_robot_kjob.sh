...
PARQUET_PATH="${PARQUET_PATH:-/opt/eveworld/gagibench/pbench_raw/data/pbench.parquet}"
PBench_OUTPUT_ROOT="${PBENCH_OUTPUT_ROOT:-/opt/eveworld/gagibench/pbench/giga_input}"
PREPARE_PBENCH_INPUT="${PREPARE_PBENCH_INPUT:-0}"

OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot}"
