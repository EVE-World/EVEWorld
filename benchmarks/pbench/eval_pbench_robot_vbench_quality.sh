...
OUTPUT_ROOT="${OUTPUT_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot_vbench_quality}"
METADATA_JSONL="${METADATA_JSONL:-/opt/eveworld/gagibench/pbench/giga_input/pbench_robot_it2v.metadata.jsonl}"
SOURCE_VIDEO_DIR="${SOURCE_VIDEO_DIR:-/data/datasets/giga_world_0_outputs/pbench_robot_serving_full_20260612_145541}"
DOMAIN_SUMMARY="${DOMAIN_SUMMARY:-/data/datasets/giga_world_0_outputs/pbench_robot_qwen_vqa_eval/20260613_131107_qwen36vl/qwen_vqa_summary.json}"
RESOLUTION_NAME="${RESOLUTION_NAME:-pbench_robot}"
VBENCH_CACHE_DIR="${VBENCH_CACHE_DIR:-/data/datasets/vbench_cache}"
...
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-/data/datasets/.cache}"
export TORCH_HOME="${TORCH_HOME:-/data/datasets/torch_cache}"
export HF_HOME="${HF_HOME:-/data/datasets/.hf_home}"
export HF_XET_CACHE="${HF_XET_CACHE:-/data/datasets/.hf_xet_cache}"
