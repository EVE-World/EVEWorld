...
DEFAULT_METADATA_JSONL = Path("/opt/eveworld/gagibench/pbench/giga_input/pbench_robot_it2v.metadata.jsonl")
DEFAULT_SOURCE_VIDEO_DIR = Path("/data/datasets/giga_world_0_outputs/pbench_robot_serving_full_20260612_145541")
DEFAULT_OUTPUT_ROOT = Path("/data/datasets/giga_world_0_outputs/pbench_robot_vbench_quality")
