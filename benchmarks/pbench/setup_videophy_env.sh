...
VENV_DIR="${VENV_DIR:-/data/datasets/envs/videophy_venv}"
HF_HOME="${HF_HOME:-/data/datasets/.hf_home}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-/data/datasets/models/videocon_physics}"
...
if [[ ! -x "${VENV_DIR}/bin/python" ]]; then
  /opt/eveworld/miniconda/envs/giga_models/bin/python -m venv "${VENV_DIR}"
fi
