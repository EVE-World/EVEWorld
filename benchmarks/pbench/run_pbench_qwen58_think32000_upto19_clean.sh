...
PRETRAIN_GEN_ROOT="${PRETRAIN_GEN_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot_length_sweep}"
PRETRAIN_EVAL_ROOT="${PRETRAIN_EVAL_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot_qwen_vqa_eval}"
PRETRAIN_SWEEP_ID="${PRETRAIN_SWEEP_ID:-pbench_len_sweep_full_8gpu}"

GR1_GEN_ROOT="${GR1_GEN_ROOT:-/data/datasets/giga_world_0_outputs/gr1_pbench_robot_length_sweep}"
GR1_EVAL_ROOT="${GR1_EVAL_ROOT:-/data/datasets/giga_world_0_outputs/gr1_pbench_robot_qwen_vqa_eval}"
