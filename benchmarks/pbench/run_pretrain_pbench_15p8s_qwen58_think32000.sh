...
# Standalone Qwen Domain/VQA eval for Pretrain PBench 15.8s.
# Uses Qwen3.6-VL endpoint, 32000 max tokens, thinking enabled.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_DIR="$(cd "${SCRIPT_DIR}/.." && pwd)"

VIDEO_DIR="${VIDEO_DIR:-/data/datasets/giga_world_0_outputs/pbench_robot_length_sweep/pbench_robot_15p8s_full_pbench_len_sweep_full_8gpu}"
EVAL_DIR="${EVAL_DIR:-/data/datasets/giga_world_0_outputs/pbench_robot_qwen_vqa_eval/pbench_robot_15p8s_full_pbench_len_sweep_full_8gpu_domain_qwen36vl_58_think32000}"
...
echo "Pretrain PBench 15.8s Qwen 32000+thinking"
