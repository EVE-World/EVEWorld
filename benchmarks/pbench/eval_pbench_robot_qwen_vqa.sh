...
VIDEO_DIR="${VIDEO_DIR:-/data/datasets/giga_world_0_outputs/pbench_robot_serving_full_20260612_145541}"
EVAL_ROOT="${EVAL_ROOT:-/data/datasets/giga_world_0_outputs/pbench_robot_qwen_vqa_eval}"
