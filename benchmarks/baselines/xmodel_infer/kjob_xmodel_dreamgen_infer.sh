...
XMODEL_EVAL_ROOT="${XMODEL_EVAL_ROOT:-/data/datasets/gr1_dreamgen_eval/xmodel_eval}"
DATA_PATH="${DATA_PATH:-/data/datasets/gr1_dreamgen_eval/giga_input/gr1_dreamgen_it2v.json}"
